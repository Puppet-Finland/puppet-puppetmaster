...
)
{
  ...
  if $with_foreman_proxy {
    ...
    class { '::puppetmaster::foreman_proxy':
      ...
      foreman_proxy_oauth_consumer_key         => $foreman_proxy_oauth_consumer_key,
      foreman_proxy_oauth_consumer_secret      => $foreman_proxy_oauth_consumer_secret,
      foreman_proxy_templates                  => $foreman_proxy_templates,
      foreman_proxy_templates_listen_on        => $foreman_proxy_templates_listen_on,
      foreman_proxy_template_url               => $foreman_proxy_template_url,
      foreman_proxy_http_port                  => $foreman_proxy_http_port,
      foreman_proxy_manage_sudoersd            => $foreman_proxy_manage_sudoersd,
      foreman_proxy_puppet_url                 => $foreman_proxy_puppet_url,
      foreman_proxy_puppet_use_environment_api => $foreman_proxy_puppet_use_environment_api,
      foreman_proxy_puppetca_listen_on         => $foreman_proxy_puppetca_listen_on,
      foreman_proxy_puppet_listen_on           => $foreman_proxy_puppet_listen_on,
      foreman_proxy_puppetrun_cmd              => $foreman_proxy_puppetrun_cmd,
      foreman_proxy_puppetrun_provider         => $foreman_proxy_puppetrun_provider,
      foreman_proxy_customrun_cmd              => $foreman_proxy_customrun_cmd,
      foreman_proxy_customrun_args             => $foreman_proxy_customrun_args,
      foreman_proxy_mcollective_user           => $foreman_proxy_mcollective_user,
      foreman_proxy_puppetssh_sudo             => $foreman_proxy_puppetssh_sudo,
      foreman_proxy_puppetssh_user             => $foreman_proxy_puppetssh_user,
      foreman_proxy_puppetssh_keyfile          => $foreman_proxy_puppetssh_keyfile,
